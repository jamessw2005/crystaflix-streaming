...
$plan = new Plan();
$plan->setName('CrystaFlix monthly subscription')
...
$paymentDefinition->setName('Regular Payments')
  ...
  ->setAmount(new Currency(array('value' => 2.99, 'currency' => 'USD')));
...
$merchantPreferences->setReturnUrl($returnUrl . "?success=true")
  ...
  ->setSetupFee(new Currency(array('value' => 2.99, 'currency' => 'USD')));
